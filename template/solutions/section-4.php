<div id="section-industri-konstruksi" class="wrap_solusi move_space"> 
  <section class="daftar-solusi pertambangan-section bg_abstract">
    <div class="container">
      <div class="row">

        <?php
        $page = get_page_by_path('daftar-solusi/section-industri-konstruksi');
        ...
        <!-- RIGHT CONTENT -->
        <div class="col-12 col-lg-7 right_side">
          <?php if ($title): ?>
        ...
        <?php endif; ?>
         ...
         <!-- LEFT SLIDER -->
         <div class="col-12 col-lg-5 space_d_solusi">
  ...
  <section class="product-list-section mt-4">
    <div class="brand-section container">

      <div class="brand-header">
      <h2 class="section-title">Produk Industri Konstruksi</h2>
        <?php
        $term = get_term_by('slug', 'industri-konstruksi', 'industry');
        ?>
