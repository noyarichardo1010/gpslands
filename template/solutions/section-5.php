<div id="section-properti-pengembangan-kawasan" class="wrap_solusi" data-aos="fade-up">
  <section class="wrap_solusi daftar-solusi pertambangan-section">
    <div class="container">
      <div class="row">

        <?php
        $page = get_page_by_path('daftar-solusi/section-properti-pengembangan-kawasan');
  ...
  <section class="product-list-section">
    <div class="brand-section container">
      ...
      <h2 class="section-title">Produk Properti & Pengembangan Kawasan</h2>

        <?php
        $term = get_term_by('slug', 'properti-pengembangan-kawasan', 'industry');
        ?>
        ...
        $products = new WP_Query([
          ...
          'tax_query'      => [
            [
              'taxonomy' => 'industry',
              'field'    => 'slug',
              'terms'    => 'properti-pengembangan-kawasan',
            ]
          ]
        ]);
