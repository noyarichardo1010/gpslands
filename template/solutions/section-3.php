<div id="infrastruktur-transportasi" class="wrap_solusi" data-aos="fade-up">
  <section class="wrap_solusi daftar-solusi pertambangan-section">
    <div class="container">
      <div class="row">
        ...
        <?php
        // Ambil page
        $page = get_page_by_path('daftar-solusi/infrastruktur-transportasi');
  ...
  <section class="product-list-section">
    <div class="brand-section container">
      ...
      <h2 class="section-title">Produk Infrastruktur & Transportasi</h2>

        <?php
        $term = get_term_by('slug', 'infrastruktur-transportasi', 'industry');
        ?>
        ...
        $products = new WP_Query([
          ...
          'tax_query'      => [
            [
              'taxonomy' => 'industry',
              'field'    => 'slug',
              'terms'    => 'infrastruktur-transportasi',
            ]
          ]
        ]);
