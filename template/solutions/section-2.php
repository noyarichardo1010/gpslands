<div id="perkebunan-kehutanan" class="wrap_solusi move_space">
  <section class="daftar-solusi pertambangan-section bg_abstract">
    <div class="container">
      <div class="row">

        <?php
        $page = get_page_by_path('daftar-solusi/perkebunan-kehutanan');
  ...
  <section class="product-list-section mt-4">
    <div class="brand-section container">
      ...
      <div class="brand-header">
        <h2 class="section-title">Produk Perkebunan & Kehutanan</h2>
        <?php
        $term = get_term_by('slug', 'perkebunan-kehutanan', 'industry');
        ?>
