...
$industry_term = get_queried_object();
?>
            ...
            <div class="product-filter">
                ...
                <div class="filter-industry d-none">
                    ...
                    $industries = !empty($product_ids)
                        ? wp_get_object_terms($product_ids, 'industry', ['orderby' => 'name'])
                        : [];
    ...
    <div class="row" data-aos="fade-up">
        ...
        <div class="col-6 col-md-3 product-item"
            ...
            <div class="product-content">
                ...
                <!-- <span class="brand_product"><?php echo esc_html($industry->name); ?></span> -->
                <?php
                $brand_terms = wp_get_post_terms(get_the_ID(), 'brand-products');
